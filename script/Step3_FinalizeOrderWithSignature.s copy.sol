...
contract Step3_FinalizeOrder is Script {
    function run() external {
        ...
        // Use finaliseWithSignature - allows solver to finalize on behalf of user with signature
        bytes32[] memory solvers = new bytes32[](1);
        solvers[0] = solverIdentifier;
        settlerCompact.finaliseWithSignature(
            order,
            signatures,
            timestamps,
            solvers,
        ...
        console.log("Order finalized successfully using finaliseWithSignature!");
